...
INSERT INTO users (full_name, student_id, password, role) VALUES
('De Asis, Diana Kyla, Ignacio', '21-01-1155', 'pass123', 'User');
...
('Black Wallet', 'Leather wallet with school ID inside', 'Accessories', 'Found', 'ASCOT ENTRANCE', '2026-04-01 09:30:00', 1, 'Open', 'What color is the school ID inside?'),
('iPhone 14', 'Rose gold, cracked screen protector', 'Electronics', 'Lost', 'Engineering Building', '2026-04-03 14:15:00', 2, 'Open', NULL),
('Blue Umbrella', 'Folding umbrella, navy blue color', 'Others', 'Found', 'General Education Buildings', '2026-04-05 11:00:00', 1, 'Open', 'What brand is the umbrella?');
